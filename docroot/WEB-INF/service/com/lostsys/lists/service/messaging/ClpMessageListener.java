...
package com.lostsys.lists.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			TaskItemLocalServiceUtil.clearService();

			TaskItemCommentLocalServiceUtil.clearService();

			TaskListLocalServiceUtil.clearService();
		}
	}
}