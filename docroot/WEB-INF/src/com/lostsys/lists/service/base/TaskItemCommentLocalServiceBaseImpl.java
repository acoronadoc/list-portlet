...
/**
 * Provides the base implementation for the task item comment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lostsys.lists.service.impl.TaskItemCommentLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TaskItemCommentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TaskItemCommentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.lostsys.lists.service.TaskItemCommentLocalServiceUtil} to access the task item comment local service.
	 */
	...
	@Override
	public TaskItemComment addTaskItemComment(TaskItemComment taskItemComment)
		throws SystemException {
		taskItemComment.setNew(true);

		return taskItemCommentPersistence.update(taskItemComment);
	}
	 ...
	 */
	@Override
	public TaskItemComment createTaskItemComment(long id) {
		return taskItemCommentPersistence.create(id);
	}
	...
	@Override
	public TaskItemComment deleteTaskItemComment(long id)
		throws PortalException, SystemException {
		return taskItemCommentPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TaskItemComment deleteTaskItemComment(
		TaskItemComment taskItemComment) throws SystemException {
		return taskItemCommentPersistence.remove(taskItemComment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaskItemComment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return taskItemCommentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return taskItemCommentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaskItemComment fetchTaskItemComment(long id)
		throws SystemException {
		return taskItemCommentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TaskItemComment getTaskItemComment(long id)
		throws PortalException, SystemException {
		return taskItemCommentPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return taskItemCommentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaskItemComment> getTaskItemComments(int start, int end)
		throws SystemException {
		return taskItemCommentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTaskItemCommentsCount() throws SystemException {
		return taskItemCommentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TaskItemComment updateTaskItemComment(
		TaskItemComment taskItemComment) throws SystemException {
		return taskItemCommentPersistence.update(taskItemComment);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.lostsys.lists.model.TaskItemComment",
			taskItemCommentLocalService);
	}
	...
	private TaskItemCommentLocalServiceClpInvoker _clpInvoker = new TaskItemCommentLocalServiceClpInvoker();
}