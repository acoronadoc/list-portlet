...
/**
 * Provides the base implementation for the task item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lostsys.lists.service.impl.TaskItemLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TaskItemLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements TaskItemLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.lostsys.lists.service.TaskItemLocalServiceUtil} to access the task item local service.
	 */
	...
	@Override
	public TaskItem addTaskItem(TaskItem taskItem) throws SystemException {
		taskItem.setNew(true);

		return taskItemPersistence.update(taskItem);
	}
	 ...
	 */
	@Override
	public TaskItem createTaskItem(long id) {
		return taskItemPersistence.create(id);
	}
	...
	@Override
	public TaskItem deleteTaskItem(long id)
		throws PortalException, SystemException {
		return taskItemPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TaskItem deleteTaskItem(TaskItem taskItem) throws SystemException {
		return taskItemPersistence.remove(taskItem);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaskItem.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return taskItemPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return taskItemPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return taskItemPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return taskItemPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaskItem fetchTaskItem(long id) throws SystemException {
		return taskItemPersistence.fetchByPrimaryKey(id);
	}
	...
	public TaskItem getTaskItem(long id)
		throws PortalException, SystemException {
		return taskItemPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return taskItemPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaskItem> getTaskItems(int start, int end)
		throws SystemException {
		return taskItemPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTaskItemsCount() throws SystemException {
		return taskItemPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TaskItem updateTaskItem(TaskItem taskItem) throws SystemException {
		return taskItemPersistence.update(taskItem);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.lostsys.lists.model.TaskItem",
			taskItemLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = taskItemPersistence.getDataSource();
	...
	private TaskItemLocalServiceClpInvoker _clpInvoker = new TaskItemLocalServiceClpInvoker();
}